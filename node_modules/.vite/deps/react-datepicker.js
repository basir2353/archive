import {
  ...
  subYears,
  toDate
} from "./chunk-5ATIYEWB.js";
import {
  require_react_dom
} from "./chunk-YNX5KIZ4.js";
import {
  require_react
} from "./chunk-HZWFTSDE.js";
import {
  __toESM
...
function isValid2(date, minDate) {
  return isValid(date) && !isBefore(date, minDate !== null && minDate !== void 0 ? minDate : new Date("1/1/1800"));
}
...
function isDayExcluded(day, _a2) {
  ...
  return excludeDates && excludeDates.some(function(excludeDate) {
    ...
    if (excludeDate instanceof Date) {
      ...
      return isSameDay2(day, (_a3 = excludeDate.date) !== null && _a3 !== void 0 ? _a3 : new Date());
    }
  }) || false;
}
